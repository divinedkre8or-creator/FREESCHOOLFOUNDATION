...
| 2026-09-22 | Unapplied Remind  | VERIFIED    | Admin panel email reminders for unapplied and draft registered users implemented via Resend Batch API; audience targeting added to Communications Center, sub-filter tabs, multi-selection, and reminder composer modal added to Registered Users table.       |
